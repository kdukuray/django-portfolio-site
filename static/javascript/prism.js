/* PrismJS 1.29.0
https://prismjs.com/download.html#themes=prism&languages=markup+css+clike+javascript+armasm+bash+basic+c+csharp+cpp+cmake+dart+docker+elixir+erlang+fortran+gdscript+git+go+graphql+haskell+ignore+java+json+julia+kotlin+lisp+llvm+lua+makefile+markdown+markup-templating+matlab+mongodb+nasm+nginx+objectivec+ocaml+pascal+perl+php+powershell+python+r+jsx+tsx+rust+sass+scala+solution-file+sql+swift+toml+typescript+verilog+wasm+yaml+zig */
